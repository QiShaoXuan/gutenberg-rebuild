      ...
      transform: function transform(files, onChange) {
        ...
        (0, _editor.mediaUpload)({
          ...
          onFileChange: function onFileChange(images) {
            var imagesAttr = images.map(_edit.pickRelevantMediaFiles);
            onChange(block.clientId, {
              ids: (0, _lodash.map)(imagesAttr, 'id'),
              images: imagesAttr
            });
          },
          allowedTypes: ['image']
  ...
  deprecated: [{
    ...
    migrate: function migrate(attributes) {
      return (0, _objectSpread2.default)({}, attributes, {
        ids: (0, _lodash.map)(attributes.images, function (_ref12) {
          var id = _ref12.id;
    ...
    save: function save(_ref15) {
      ...
      var images = attributes.images,
          ...
          columns = _attributes$columns4 === void 0 ? (0, _edit.defaultColumnsNumber)(attributes) : _attributes$columns4,
