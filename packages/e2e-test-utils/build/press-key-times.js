...
function _promiseSequence() {
  _promiseSequence = (0, _asyncToGenerator2.default)(
  /*#__PURE__*/
  _regenerator.default.mark(function _callee(sequence) {
...
function pressKeyTimes(_x2, _x3) {
  return _pressKeyTimes.apply(this, arguments);
}

function _pressKeyTimes() {
  _pressKeyTimes = (0, _asyncToGenerator2.default)(
  /*#__PURE__*/
  _regenerator.default.mark(function _callee2(key, count) {
    return _regenerator.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            return _context2.abrupt("return", promiseSequence((0, _lodash.times)(count, function () {
              return function () {
