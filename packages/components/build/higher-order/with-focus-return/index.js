  ...
  return function (WrappedComponent) {
    ...
    function (_Component) {
      ...
      (0, _createClass2.default)(FocusReturn, [{
        ...
        value: function componentWillUnmount() {
          ...
          var stack = [].concat((0, _toConsumableArray2.default)(_lodash.without.apply(void 0, [this.props.focusHistory].concat((0, _toConsumableArray2.default)(ownFocusedElements)))), [activeElementOnMount]);
          var candidate;
    ...
    return function (props) {
      return (0, _element.createElement)(_context.Consumer, null, function (context) {
        return (0, _element.createElement)(FocusReturn, (0, _extends2.default)({}, props, context));
      });
    };
  };
}
