...
function (_Component) {
  ...
  function FocalPointPicker() {
    ...
    _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(FocalPointPicker).apply(this, arguments));
    ...
    _this.horizontalPositionChanged = _this.horizontalPositionChanged.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
    _this.verticalPositionChanged = _this.verticalPositionChanged.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
    _this.onLoad = _this.onLoad.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
    return _this;
  }
