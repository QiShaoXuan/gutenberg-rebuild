...
function (_Component) {
  ...
  function FocalPointPicker() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(FocalPointPicker).apply(this, arguments));
    ...
    _this.horizontalPositionChanged = _this.horizontalPositionChanged.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.verticalPositionChanged = _this.verticalPositionChanged.bind(_assertThisInitialized(_assertThisInitialized(_this)));
