...
function getPatterns(_ref) {
  ...
  var prefixTransforms = (0, _blocks.getBlockTransforms)('from').filter(function (_ref2) {
    var type = _ref2.type;
    return type === 'prefix';
  });
  return [function (record) {
    ...
    var start = (0, _richText.getSelectionStart)(record);
    ...
    var transformation = (0, _blocks.findTransform)(prefixTransforms, function (_ref3) {
    ...
    var content = valueToFormat((0, _richText.slice)(record, start, text.length));
    ...
    record = (0, _richText.remove)(record, startIndex, startIndex + 1);
    record = (0, _richText.remove)(record, endIndex, endIndex + 1);
