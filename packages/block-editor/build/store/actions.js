...
function selectPreviousBlock(clientId) {
  ...
  return _regenerator.default.wrap(function selectPreviousBlock$(_context) {
    while (1) {
...
function selectNextBlock(clientId) {
  ...
  return _regenerator.default.wrap(function selectNextBlock$(_context2) {
    while (1) {
...
function removeBlocks(clientIds) {
  var selectPrevious,
      count,
      _args3 = arguments;
  return _regenerator.default.wrap(function removeBlocks$(_context3) {
    while (1) {
